...
object Destinations {
    ...
    const val DEEP_LINK_PATTERN_HTTPS = "https://scenicroute.app/d/{driveId}"
    const val DEEP_LINK_PATTERN_SCHEME = "scenicroute://drive/{driveId}"

    fun shareUrlFor(id: String): String = "scenicroute://drive/$id"
    fun webUrlFor(id: String): String = "https://scenicroute.app/d/$id"
