...
class DriveExporter @Inject constructor(
    ...
    private fun renderGpx(
        ...
        description: String,
        startedAt: Long,
        track: List<com.scenicroute.data.db.entities.TrackPointEntity>,
        waypoints: List<com.scenicroute.data.db.entities.WaypointEntity>,
    ): String = buildString {
        append("""<?xml version="1.0" encoding="UTF-8"?>""")
        append('\n')
        append("""<gpx version="1.1" creator="Scenic Route" xmlns="http://www.topografix.com/GPX/1/1">""")
        append('\n')
        append("  <metadata>\n")
